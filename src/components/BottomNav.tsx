...
export function BottomNav() {
  const base = 'flex flex-col items-center gap-0.5 py-2.5 px-2 transition-colors flex-1'
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-[#0a0a0a] border-t border-[#1a1a1a] flex justify-around z-50"
      ...
      <NavLink to="/tv" className={({ isActive }) => `${base} ${isActive ? active : inactive}`}>
        {({ isActive }) => (<>
          ...
          <span className="text-[9px] font-bold tracking-wide">SÉRIES</span>
        </>)}
      </NavLink>
      ...
      <NavLink to="/movies" className={({ isActive }) => `${base} ${isActive ? active : inactive}`}>
        {({ isActive }) => (<>
          ...
          <span className="text-[9px] font-bold tracking-wide">FILMES</span>
        </>)}
      </NavLink>
      ...
      <NavLink to="/explorar" className={({ isActive }) => `${base} ${isActive ? active : inactive}`}>
        {({ isActive }) => (<>
          ...
          <span className="text-[9px] font-bold tracking-wide">EXPLORAR</span>
        </>)}
      </NavLink>
